...
-- ============================================================
-- FIX: Blizzard removed the global DebuffTypeColor table in a
-- recent client update and replaced it with individual globals
-- (DEBUFF_TYPE_MAGIC_COLOR, DEBUFF_TYPE_CURSE_COLOR, etc).
-- Rebuild DebuffTypeColor from those globals so auras.lua and
-- highlight.lua don't error out trying to index a nil table.
-- Classic-default colors are used only as a last-resort fallback.
-- ============================================================
